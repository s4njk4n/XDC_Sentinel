...
# XDC Sentinel v1.0 - Open-source XDC node monitor
# Fork from https://github.com/s4njk4n/XDC_Sentinel
...
# Validate CSV in GitHub Secrets
if [ -z "$(cat "$CSV_FILE" | tail -n +2)" ]; then
  write_to_log "Error: No nodes defined in CSV"
  exit 1
fi
